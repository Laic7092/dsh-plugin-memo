...
import { buildIndex, buildMap, estimateTokens, fileDetail, findInIndex, INDEX_VERSION, indexMeta, refreshIndex, staleFiles, TS_MIN_TOKENS } from "../lib/indexer.js";
...
test("tree-sitter replaces the guesses where a grammar exists", async (t) => {
  ...
  if (analyzer === null) {
    t.skip("web-tree-sitter or tree-sitter-wasms is not installed");
    return;
  }
