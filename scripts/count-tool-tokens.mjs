 ...
 * `renderToolsSdk` from `@deepseek-ai/dsh-tools`, counted with `lib/tokenizer.js`
 ...
 *
 *   node scripts/count-tool-tokens.mjs
 *   git worktree add /tmp/memo-old HEAD~1 && node scripts/count-tool-tokens.mjs /tmp/memo-old/lib/index.js
 *
...
const USAGE = "usage: node scripts/count-tool-tokens.mjs [--json] [--per-tool] [path/to/lib/index.js]";
