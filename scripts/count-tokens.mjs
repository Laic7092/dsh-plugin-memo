 ...
 *
 *   node scripts/count-tokens.mjs "Hello!"
 *   node scripts/count-tokens.mjs --estimate lib/indexer.js
 *   cat lib/tokenizer.js | node scripts/count-tokens.mjs
 *   node scripts/count-tokens.mjs --ids "Hello!"      # the ids, for a fixture
 *
...
const USAGE = [
  "usage: node scripts/count-tokens.mjs [--ids] [--estimate] [--total] [--vocab] [text-or-file ...]",
  "",
